...
Path("outputs/iris/rae").mkdir(parents=True, exist_ok=True)
...
path_removal = (
    "outputs/iris/rae/mlp" + "_".join(map(str, hidden_layer_size)) + "_removal.npz"
)
path_shap = "outputs/iris/rae/mlp" + "_".join(map(str, hidden_layer_size)) + "_shap.npz"
