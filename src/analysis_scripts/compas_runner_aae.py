...
Path("models/compas").mkdir(parents=True, exist_ok=True)
Path("outputs/compas/aae").mkdir(parents=True, exist_ok=True)
...
parser = argparse.ArgumentParser(
    description="Train and analyse MLPs for compas dataset.",
)
parser.add_argument(
    "--hidden_layer_size",
    type=str,
...
model_file = "models/compas/mlp" + "_".join(map(str, hidden_layer_size)) + ".joblib"
accuracy_file = "models/compas/mlp" + "_".join(map(str, hidden_layer_size)) + ".txt"
...
path_gradient = (
    "outputs/compas/aae/mlp" + "_".join(map(str, hidden_layer_size)) + "_gradient.npz"
)
path_removal = (
    "outputs/compas/aae/mlp" + "_".join(map(str, hidden_layer_size)) + "_removal.npz"
)
path_shap = (
    "outputs/compas/aae/mlp" + "_".join(map(str, hidden_layer_size)) + "_shap.npz"
)
