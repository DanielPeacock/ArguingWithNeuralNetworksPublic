...
Path("outputs/compas/rae").mkdir(parents=True, exist_ok=True)
...
path_removal = (
    "outputs/compas/rae/mlp" + "_".join(map(str, hidden_layer_size)) + "_removal.npz"
)
path_shap = (
    "outputs/compas/rae/mlp" + "_".join(map(str, hidden_layer_size)) + "_shap.npz"
)
