...
Path("outputs/cancer/aae").mkdir(parents=True, exist_ok=True)
...
path_gradient = (
    "outputs/cancer/aae/mlp" + "_".join(map(str, hidden_layer_size)) + "_gradient.npz"
)
path_removal = (
    "outputs/cancer/aae/mlp" + "_".join(map(str, hidden_layer_size)) + "_removal.npz"
)
path_shap = (
    "outputs/cancer/aae/mlp" + "_".join(map(str, hidden_layer_size)) + "_shap.npz"
)
